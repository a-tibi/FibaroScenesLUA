...
fibaro.call(109, "setValue", "50")
end

if ((key == '1') and (atr == '"Pressed3"')) then
fibaro.call(109, "setValue", "20")
end

if ((key == '1') and (atr == '"HeldDown"')) then
fibaro.call(109, "setValue", "0")
end
--2
...
fibaro.call(119, "setValue", "50")
end

if ((key == '2') and (atr == '"Pressed3"')) then
fibaro.call(119, "setValue", "20")
end

if ((key == '2') and (atr == '"HeldDown"')) then
fibaro.call(119, "setValue", "0")
end
--3
